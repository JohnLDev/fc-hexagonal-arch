...
// Disable mocks base method.
func (m *MockProductServiceInterface) Disable(product app.ProductInterface) (bool, error) {
	m.ctrl.T.Helper()
...
// Enable mocks base method.
func (m *MockProductServiceInterface) Enable(product app.ProductInterface) (bool, error) {
	m.ctrl.T.Helper()
